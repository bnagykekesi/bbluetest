...
<div role="document" class="page">
  ...
  <header role="banner" class="l-header">
    ...
    <?php if ($top_bar): ?>
      ...
      <div class="top-bar-wrapper">
        <div class="row">
          <div class="columns large sticky contain-to-grid large-12">
  ...
  <div class="global-footer-wrapper">
    <section class="l-global-footer row" role="contentinfo">
      <?php if (!empty($page['global_footer'])): ?>
        <div class="footer columns">
